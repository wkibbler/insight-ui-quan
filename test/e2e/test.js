...
describe('basic UI tests', () => {
  ...
  beforeAll(async () => {
    ...
    const insightUIContainerOptions = {
      volumes: [
        `${rootPath}/quantisnetcore-node:/insight/node_modules/@quantisnetevo/insight-ui/quantisnetcore-node`,
        `${rootPath}/po:/insight/node_modules/@quantisnetevo/insight-ui/po`,
        `${rootPath}/public:/insight/node_modules/@quantisnetevo/insight-ui/public`,
      ],
    };
    ...
    await masterNode.quantisnetCore.getApi().generate(15);
  });
  ...
  describe('Home Page', () => {
    ...
    it('should be able search by block number', async () => {
      ...
      expect(blockReward).equal('500 QUAN');
