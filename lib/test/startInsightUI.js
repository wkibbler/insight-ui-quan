...
const startQuantsisnetCore = require('@quantisnetevo/dp-services-ctl/lib/services/quantisnetCore/startQuantsisnetCore');
 ...
 * @property {QuantsisnetCore} quantisnetCore
...
startInsightUI.many = async function many(number, options = {}) {
  ...
  const quantisnetCoreInstancesPromise = startQuantsisnetCore.many(number, options.quantisnetCore);
